...
class GameSession:
    ...
    def __init__(self, game_data_dir: str, config: Optional[Dict[str, Any]] = None, provider_id: int = 4, provider_config: Optional[Dict[str, Any]] = None):
        """
        ...
        self.command_processor.setup_llm_provider(provider_id, complete_config, interactive=False)
    ...
    def get_initial_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "metadata": {
                "combat_active": False,
                "inventory_count": len(self.game_state.inventory),
                "available_commands": ["look", "go", "talk", "take", "inventory", "help"]
            }
        }
